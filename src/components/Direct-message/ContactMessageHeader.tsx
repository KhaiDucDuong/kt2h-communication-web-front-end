    ...
    <section className="flex flex-row justify-between m-auto size-full ">
      ...
      <div className="w-fit h-full flex flex-col justify-center">
        <div className="h-fit flex flex-row justify-between mr-[14px]">
          ...
          />
          <div className={cn("w-[38px] h-[38px] rounded-full flex justify-center hover:bg-dark-1", props.isMoreInfoPannelExpanded && "bg-dark-1")}>
            <FontAwesomeIcon
              icon={faEllipsis}
              className={cn("text-gray-5 text-[30px] cursor-pointer mx-[10px] m-auto ", props.isMoreInfoPannelExpanded && "text-gray-4")}
